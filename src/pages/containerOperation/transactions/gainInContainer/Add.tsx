...
import { fromLocationGateInOption, gateInContainerOption, gateInOption, icdFcsOption, securityOption, statusOption, transhipmentOption, voyageOption } from "@/pages/options";
...
const Add: React.FC = () => {
    ...
    const validationRules: ValidationRules = {
        ...
        vesselName: { required: true, minLength: 2, maxLength: 255 },
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        const payload = {
            ...
            foreignCoastalFlag: formData?.foriegnCostal
        };
        try {
        ...
        <div className="_rkContentBorder container-fluid py-3" style={{ border: "1px solid black", marginTop: "7px", marginBottom: "70px" }}>
            ...
            <form onSubmit={handleFormSubmit}>
                <div className="row">
                    ...
                    <RowFormInputField row="col-md-4" col1="col-md-3" col2="col-md-9" label="In Time" isDefault={true} name="txtInTime" inputValue={formData.txtInTime} error={errors.txtInTime} required onChange={handleChange} />
                    <RowFormInputField row="col-md-4" col1="col-md-3" col2="col-md-8" label="Vehicle No" max={15} name="vehicleNo" inputValue={formData.vehicleNo} error={errors.vehicleNo} required onChange={handleChange} />
                    ...
                    <RowFormSelectField row="col-md-4" col1="col-md-3" col2="col-md-6" name="locationName" label="To Location" options={fromLocationGateInOption} value={formData.locationName} error={errors.locationName} onChange={handleSelectChange} isLoading={false} formData={formData} />
                    ...
                    <RowFormCheckField row="col-md-4" col1="col-md-3" col2="col-md-8" label="Shipper" isDefault={true} name="shipperName" inputValue={formData.shipperName} error={errors.shipperName} onChange={handleChange} click={() => onChangeSelect("shipper", formData.shipperName)} />

                    <RowFormCheckField row="col-md-4" col1="col-md-3" col2="col-md-9" required label="Vessel Name" isDefault={true} name="vesselName" inputValue={formData.vesselName} error={errors.vesselName} onChange={handleChange} click={() => onChangeSelect("vessel", formData.vesselNo)} />
                    ...
                    <RowFormCheckField row="col-md-4" col1="col-md-3" col2="col-md-9" label="Port of Destination" isDefault={true} name="portName" inputValue={formData.portName} error={errors.portName} required onChange={handleChange} click={() => onChangeSelect("port", formData.portName)} />
                    ...
                    <RowFormSelectField row="col-md-4" col1="col-md-3" col2="col-md-6" name="gateInThrough" isTrue={true} label="Gate In Through" options={gateInOption} value={formData.gateInThrough} error={errors.gateInThrough} onChange={handleSelectChange} isLoading={false} required formData={formData} />
                ...
                <div className="row">
                    ...
                    <RowFormSelectField row="col-md-4" col1="col-md-3" col2="col-md-6" name="containerStatus" label="Container Status" options={gateInContainerOption} value={formData.containerStatus} error={errors.containerStatus} onChange={handleSelectChange} isLoading={false} formData={formData} />
                    ...
                    <RowFormSelectField row="col-md-4" col1="col-md-3" col2="col-md-6" name="foriegnCostal" isTrue={true} label="Voyage" options={voyageOption} value={formData.foriegnCostal} error={errors.foriegnCostal} onChange={handleSelectChange} isLoading={false} formData={formData} />
                    ...
                    <RowFormSelectField row="col-md-4" col1="col-md-3" col2="col-md-6" name="shutOut" label="Shut Out" options={statusOption} value={formData.shutOut} error={errors.shutOut} onChange={handleSelectChange} isLoading={false} formData={formData} />
