        ...
        <div className="_rkContentBorder container-fluid py-3" style={{ border: "1px solid black", marginTop: "7px", marginBottom: "70px" }}>
            ...
            <form onSubmit={handleFormSubmit}>
                <div className="row">
                    ...
                    <RowFormSelectField name="gateInThrough" isTrue={true} label="Gate In Through" options={gateInOption} value={formData.gateInThrough} error={errors.gateInThrough} onChange={handleSelectChange} isLoading={false} required formData={formData} />
                ...
                <div className="row">
                    ...
                    <RowFormSelectField name="foriegnCostal" isTrue={true} label="Voyage" options={voyageOption} value={formData.foriegnCostal} error={errors.foriegnCostal} onChange={handleSelectChange} isLoading={false} formData={formData} />
